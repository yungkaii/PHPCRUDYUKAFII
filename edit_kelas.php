...
$stmt = mysqli_prepare($koneksi, "SELECT id_kelas, nama_kelas FROM kelas WHERE id_kelas = ?");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form method="POST" action="/akademik/update_kelas.php">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputEmail3" name="id_kelas_display" value="<?php echo $d['id_kelas']; ?>" disabled>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputPassword3" class="col-sm-2 col-form-label">Nama Kelas</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputPassword3" name="nama_kelas" value="<?php echo $d['nama_kelas']; ?>">
                        </div>
                    </div>
                    <!-- No extra fields: kelas table only has id_kelas and nama_kelas in schema -->
                    <button type="submit" class="btn btn-primary">Update</button>
                    <a href="/akademik/kelas.php" class="btn btn-secondary">Batal</a>
                    </form>
